/* KallistiOS ##version##
   ...
   placed in the TLS segment by the compiler. On x86 the compiler
   is then able to generate trivial %gs-relative lookups, the
   segment base holding the address of the current thread's
   control block.
