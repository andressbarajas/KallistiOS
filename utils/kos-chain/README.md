...
- **Xbox**: `i686-pc-xbox` toolchain, an experimental cross-compiler targeting
the Pentium III-class CPU in the original Microsoft Xbox. It emits 32-bit
PE/COFF objects for a later XBE conversion stage.
